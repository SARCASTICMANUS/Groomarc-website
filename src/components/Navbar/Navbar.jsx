    ...
    <>
      ...
      <header className="relative z-20 w-full  bg-transparent justify-center  lg:border-slate-200 lg:backdrop-blur-sm ">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            {/*      <!-- Brand logo --> */}
            <div className="flex items-center lg:-mt-4 gap-2 whitespace-nowrap py-3 text-lg  focus:outline-none lg:flex-1">
            <a
              id="WindUI"
            ...
            >
              <img className="lg:w-50 w-40" src={Logo} />
            ...
            >
              ...
              <li role="none" className="flex items-stretch">
                <a
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center gap-2 border-1 py-2 transition-colors duration-300 hover:text-black text-white hover:bg-white hover:border-black-900 focus:text-white focus:outline-none focus-visible:outline-none lg:px-8 md:px-12 sm:mx-16 bg-black my-5 rounded-3xl"
